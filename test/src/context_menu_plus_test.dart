...
import 'package:flutter/cupertino.dart' hide CupertinoContextMenuBuilder;
...
void main() {
  ...
  Widget getContextMenu({Alignment alignment = Alignment.center, Size screenSize = const Size(800.0, 600.0), Widget? child}) {
    return CupertinoApp(
        ...
        child: MediaQuery(
          ...
          child: Align(
            ...
            child: CupertinoContextMenu(
              actions: <CupertinoContextMenuAction>[CupertinoContextMenuAction(child: Text('CupertinoContextMenuAction $alignment'))],
  ...
  Widget getBuilderContextMenu({Alignment alignment = Alignment.center, Size screenSize = const Size(800.0, 600.0), CupertinoContextMenuBuilder? builder}) {
    return CupertinoApp(
      home: CupertinoPageScaffold(
        child: MediaQuery(
          data: MediaQueryData(size: screenSize),
  ...
  Finder findDecoyChild(Widget child) {
    return find.descendant(of: find.byWidgetPredicate((Widget w) => '${w.runtimeType}' == '_DecoyChild'), matching: find.byWidget(child));
  }

  // Finds the child widget rendered inside of _ContextMenuRouteStatic.
  Finder findStatic() {
    return find.descendant(of: find.byType(CupertinoApp), matching: find.byWidgetPredicate((Widget w) => '${w.runtimeType}' == '_ContextMenuRouteStatic'));
  }
  ...
  Finder findStaticChildColor(WidgetTester tester) {
    return find.descendant(of: findStatic(), matching: find.byWidgetPredicate((Widget widget) => widget is ColoredBox && widget.color != CupertinoColors.activeOrange));
  }
  ...
  group('CupertinoContextMenu before and during opening', () {
    ...
    testWidgets('_DecoyChild preserves the child color', (WidgetTester tester) async {
      ...
      final Finder decoyChild = find.byWidgetPredicate((Widget w) => '${w.runtimeType}' == '_DecoyChild');
      ...
      final Finder decoyChildDescendant = find.descendant(of: decoyChild, matching: find.byType(Container));
      ...
      final Finder decoyChildAfterEnding = find.byWidgetPredicate((Widget w) => '${w.runtimeType}' == '_DecoyChild');
      expect(decoyChildAfterEnding, findsNothing);
    });

    testWidgets('CupertinoContextMenuPlus shows bottomWidgetBuilder content', (WidgetTester tester) async {
      final Widget child = getChild();
          ...
          home: CupertinoPageScaffold(
            child: Center(
              child: CupertinoContextMenuPlus(
                ...
                bottomWidgetBuilder: (BuildContext context) => const Text('Custom actions'),
                child: child,
              ),
            ),
          ),
    ...
    testWidgets('CupertinoContextMenuPlus uses custom growAnimationScale', (WidgetTester tester) async {
      const double customScale = 1.3;
      final Widget child = getChild();
        ...
        CupertinoApp(
          home: CupertinoPageScaffold(
            child: MediaQuery(
              data: const MediaQueryData(size: Size(800, 600)),
              child: Center(
                child: CupertinoContextMenuPlus(actions: const <Widget>[Text('Action')], growAnimationScale: customScale, child: child),
              ),
            ),
          ),
        ),
      ...
      await tester.pump(const Duration(milliseconds: 800));
      final Rect decoyChildRect = tester.getRect(findDecoyChild(child));
      expect(decoyChildRect.width, moreOrLessEquals(childRect.width * customScale, epsilon: 0.001));

      await gesture.up();
      await tester.pumpAndSettle();
    });

    testWidgets('CupertinoContextMenuPlus uses custom growAnimationBoxShadow', (WidgetTester tester) async {
      const List<BoxShadow> customShadow = <BoxShadow>[BoxShadow(color: Color(0x6600FF00), blurRadius: 18.0, spreadRadius: 2.0)];
      final Widget child = getChild();
        ...
        CupertinoApp(
          home: CupertinoPageScaffold(
            child: MediaQuery(
              data: const MediaQueryData(size: Size(800, 600)),
              child: Center(
                child: CupertinoContextMenuPlus(actions: const <Widget>[Text('Action')], growAnimationBoxShadow: customShadow, child: child),
              ),
            ),
          ),
        ),
      ...
      final Finder decoyChild = find.byWidgetPredicate((Widget w) => '${w.runtimeType}' == '_DecoyChild');
      final Finder decoyContainer = find.descendant(of: decoyChild, matching: find.byType(Container));
      final BoxDecoration boxDecoration = (tester.firstWidget(decoyContainer) as Container).decoration! as BoxDecoration;
      final List<BoxShadow>? boxShadow = boxDecoration.boxShadow;

      expect(boxShadow, isNotNull);
      expect(boxShadow, hasLength(1));
      expect(boxShadow!.first.color, customShadow.first.color);
      expect(boxShadow.first.blurRadius, customShadow.first.blurRadius);
      expect(boxShadow.first.spreadRadius, customShadow.first.spreadRadius);

      await gesture.up();
      await tester.pumpAndSettle();
    });

    testWidgets('CupertinoContextMenuPlus bottomWidgetBuilder overrides actions', (WidgetTester tester) async {
      final Widget child = getChild();
          ...
          home: CupertinoPageScaffold(
            child: Center(
              child: CupertinoContextMenuPlus(
                ...
                bottomWidgetBuilder: (BuildContext context) => const Text('Bottom widget'),
                child: child,
              ),
            ),
          ),
    ...
    testWidgets('CupertinoContextMenuPlusController can open and close', (WidgetTester tester) async {
      final CupertinoContextMenuPlusController controller = CupertinoContextMenuPlusController();
      final Widget child = getChild();
      ...
      await tester.pumpWidget(
        CupertinoApp(
          home: CupertinoPageScaffold(
            child: Center(
              child: CupertinoContextMenuPlus(controller: controller, openGestureEnabled: false, actions: const <Widget>[Text('Action')], child: child),
            ),
          ),
        ),
      );
    ...
    testWidgets('CupertinoContextMenu with a builder can change the animation', (WidgetTester tester) async {
        ...
        getBuilderContextMenu(
          builder: (BuildContext context, Animation<double> animation) {
            return Container(
              width: 300.0,
              height: 100.0,
              decoration: BoxDecoration(color: CupertinoColors.activeOrange, borderRadius: BorderRadius.circular(25.0 * animation.value)),
            );
          },
        ),
      );
      ...
      Finder findBuilderDecoyChild() {
        return find.descendant(of: find.byWidgetPredicate((Widget w) => '${w.runtimeType}' == '_DecoyChild'), matching: find.byType(Container));
      }
    ...
    testWidgets('Hovering over Cupertino context menu updates cursor to clickable on Web', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        CupertinoApp(
          home: CupertinoPageScaffold(
            child: Center(
              child: CupertinoContextMenu(
                actions: const <CupertinoContextMenuAction>[CupertinoContextMenuAction(child: Text('CupertinoContextMenuAction One'))],
                child: child,
              ),
            ),
          ),
      ...
      await tester.pumpAndSettle();
      expect(RendererBinding.instance.mouseTracker.debugDeviceActiveCursor(1), kIsWeb ? SystemMouseCursors.click : SystemMouseCursors.basic);
    });
  ...
  group('CupertinoContextMenu when open', () {
    ...
    testWidgets('Can close CupertinoContextMenu by dragging down', (WidgetTester tester) async {
      ...
      await swipeGesture.moveBy(const Offset(0.0, 100.0), timeStamp: const Duration(milliseconds: 100));
      await tester.pump();
      ...
      await swipeGesture.moveBy(const Offset(0.0, 200.0), timeStamp: const Duration(milliseconds: 100));
      await tester.pump();
      await swipeGesture.up();
      await tester.pumpAndSettle();
      expect(findStatic(), findsNothing);
  ...
  group("Open layout differs depending on child's position on screen", () {
    testWidgets('Portrait', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(getContextMenu(alignment: Alignment.centerLeft, screenSize: portraitScreenSize, child: child));
      expect(find.byType(CupertinoContextMenuAction), findsNothing);
      await tester.pumpAndSettle();
      childRect = tester.getRect(find.byWidget(child));
      ...
      await tester.pumpWidget(getContextMenu(alignment: Alignment.centerRight, screenSize: portraitScreenSize, child: child));
      expect(find.byType(CupertinoContextMenuAction), findsNothing);
      childRect = tester.getRect(find.byWidget(child));
      gesture = await tester.startGesture(childRect.center);
      await tester.pumpAndSettle();
  ...
  testWidgets('Conflicting gesture detectors', (WidgetTester tester) async {
          ...
          home: Align(
            child: CupertinoContextMenu(
              ...
              child: GestureDetector(
                ...
                child: Container(width: 200, height: 200, key: const Key('container'), color: const Color(0xFF00FF00)),
              ),
            ),
          ),
        ),
    ...
    final Finder routeStatic = find.byWidgetPredicate((Widget w) => '${w.runtimeType}' == '_ContextMenuRouteStatic');
          ...
          builder: (BuildContext context) {
            return Center(
              child: CupertinoContextMenu(
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(CupertinoPageRoute<Widget>(builder: (BuildContext context) => const CupertinoPageScaffold(child: Text(page))));
                  },
                  child: child,
                ),
              ),
  ...
  testWidgets('Removing context menu from widget tree removes overlay', (WidgetTester tester) async {
    final Widget child = getChild();
            ...
            return Center(
              child: ctxMenuRemoved
                  ...
                  : CupertinoContextMenu(
                      actions: <Widget>[CupertinoContextMenuAction(child: const Text('Test'), onPressed: () {})],
                      child: child,
                    ),
            );
          },
  ...
  group('CupertinoContextMenu sheet shrink animation alignment - ', () {
    Future<void> testShrinkAlignment({
      ...
      final Widget child = getChild();
      await tester.pumpWidget(getContextMenu(alignment: alignment, screenSize: screenSize, child: child));
      ...
      final Finder sheetFinder = find.byWidgetPredicate((Widget widget) => widget.runtimeType.toString() == '_ContextMenuSheet');
      ...
      switch (expectedAlignment) {
        case AlignmentDirectional.topStart:
          expect(shrunkSheetRect.left, moreOrLessEquals(initialSheetRect.left, epsilon: Tolerance.defaultTolerance.distance));
        case AlignmentDirectional.topCenter:
          expect(shrunkSheetRect.center.dx, moreOrLessEquals(initialSheetRect.center.dx, epsilon: Tolerance.defaultTolerance.distance));
        case AlignmentDirectional.topEnd:
          expect(shrunkSheetRect.right, moreOrLessEquals(initialSheetRect.right, epsilon: Tolerance.defaultTolerance.distance));
        default:
    ...
    testWidgets('Portrait', (WidgetTester tester) async {
      ...
      await testShrinkAlignment(tester: tester, alignment: Alignment.centerLeft, screenSize: portraitScreenSize, expectedAlignment: AlignmentDirectional.topStart);
      await testShrinkAlignment(tester: tester, alignment: Alignment.center, screenSize: portraitScreenSize, expectedAlignment: AlignmentDirectional.topCenter);
      await testShrinkAlignment(tester: tester, alignment: Alignment.centerRight, screenSize: portraitScreenSize, expectedAlignment: AlignmentDirectional.topEnd);
    });
    ...
    testWidgets('Landscape', (WidgetTester tester) async {
      ...
      await testShrinkAlignment(tester: tester, alignment: Alignment.centerLeft, screenSize: landscapeScreenSize, expectedAlignment: AlignmentDirectional.topStart);
      await testShrinkAlignment(tester: tester, alignment: Alignment.center, screenSize: landscapeScreenSize, expectedAlignment: AlignmentDirectional.topStart);
      await testShrinkAlignment(tester: tester, alignment: Alignment.centerRight, screenSize: landscapeScreenSize, expectedAlignment: AlignmentDirectional.topEnd);
    });
  });

  testWidgets('CupertinoContextMenu respects available screen width - Portrait', (WidgetTester tester) async {
  ...
  testWidgets('CupertinoContextMenu respects available screen width - Landscape', (WidgetTester tester) async {
      ...
      CupertinoApp(
        home: Center(
          child: SizedBox.shrink(
            child: CupertinoContextMenu(actions: const <Widget>[Text('X'), Text('Y')], child: const Text('Y')),
          ),
        ),
      ),
    );
  ...
  testWidgets('CupertinoContextMenuPlus calls onOpened after opening', (WidgetTester tester) async {
    final CupertinoContextMenuPlusController controller = CupertinoContextMenuPlusController();
    int openedCount = 0;
        ...
        home: CupertinoPageScaffold(
          child: Center(
            child: CupertinoContextMenuPlus(
              ...
              actions: <Widget>[CupertinoContextMenuAction(child: const Text('Action'), onPressed: () {})],
              onOpened: () {
                openedCount += 1;
